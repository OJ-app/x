...
このテンプレートは、フォルダごとに別のアプリを作れる構成になっています。
...
各フォルダのindex.htmlが、それぞれ独立したアプリになります。

公開URLもフォルダごとに分かれます。

```html
https://ユーザー名.github.io/リポジトリ名/main/
https://ユーザー名.github.io/リポジトリ名/app/
```

アプリを増やす場合は、appフォルダをコピーして、好きな名前へ変更してください。
...
これだけで、1つのGitHubリポジトリ内に複数のマイアプリを作れます。
